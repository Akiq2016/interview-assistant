...
export const askForEvaluation = `Please provide an interview evaluation based on our interview process. give me a score from 1 to 5, 5 is the best. Here is a sample interview evaluation example:
<example>
Score: 3.5
Areas of strength:
